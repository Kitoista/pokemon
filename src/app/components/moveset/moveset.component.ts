...
// import { SelectedSetService } from 'src/app/services/selected-situation-set.service';
// import { MovesetHighscore, allTypes, log } from 'src/app/logic/models/poke-type';
...
export class MovesetComponent {
  ...
  // // constructor(public selectedMovesetService: SelectedSetService) {
  // // }
